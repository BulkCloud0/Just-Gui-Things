...
public class StampingPressBlock extends Block {
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player,
        ...
        if (tile instanceof StampingPressTileEntity && held.getItem() == ModItems.CONFIGURATOR.get()) {
            if (!world.isClientSide) {
                StampingPressTileEntity press = (StampingPressTileEntity) tile;
                MachineSideMode mode = press.cycleSideMode(hit.getDirection());
        ...
        if (!world.isClientSide) {
            if (tile instanceof StampingPressTileEntity && player instanceof ServerPlayerEntity) {
                NetworkHooks.openGui((ServerPlayerEntity) player, (StampingPressTileEntity) tile, pos);
            }
