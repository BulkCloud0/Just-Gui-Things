...
public class StampingPressContainer extends Container {
    ...
    public StampingPressContainer(int windowId, PlayerInventory playerInventory, StampingPressTileEntity tileEntity) {
    ...
    private static StampingPressTileEntity getTileEntity(PlayerInventory playerInventory, PacketBuffer buffer) {
        ...
        if (!(tile instanceof StampingPressTileEntity)) {
            throw new IllegalStateException("Stamping Press tile entity not found at " + pos);
        }
        return (StampingPressTileEntity) tile;
    }
    ...
    public int getEnergyScaled(int pixels) {
        return (int) ((long) getEnergyStored() * pixels / StampingPressTileEntity.CAPACITY);
    }
