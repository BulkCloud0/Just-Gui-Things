...
public class QuenchChamberContainer extends Container {
    ...
    public QuenchChamberContainer(int windowId, PlayerInventory playerInventory, QuenchChamberTileEntity tileEntity) {
    ...
    private static QuenchChamberTileEntity getTileEntity(PlayerInventory playerInventory, PacketBuffer buffer) {
        ...
        if (!(tile instanceof QuenchChamberTileEntity)) {
            throw new IllegalStateException("Quench Chamber tile entity not found at " + pos);
        }
        return (QuenchChamberTileEntity) tile;
    }
    ...
    public int getEnergyScaled(int pixels) {
        return (int) ((long) getEnergyStored() * pixels / QuenchChamberTileEntity.CAPACITY);
    }
