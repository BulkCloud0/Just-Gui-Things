...
public class ThermalKilnContainer extends Container {
    ...
    public ThermalKilnContainer(int windowId, PlayerInventory playerInventory, ThermalKilnTileEntity tileEntity) {
    ...
    private static ThermalKilnTileEntity getTileEntity(PlayerInventory playerInventory, PacketBuffer buffer) {
        ...
        if (!(tile instanceof ThermalKilnTileEntity)) {
            throw new IllegalStateException("Thermal Kiln tile entity not found at " + pos);
        }
        return (ThermalKilnTileEntity) tile;
    }
    ...
    public int getEnergyScaled(int pixels) {
        return (int) ((long) getEnergyStored() * pixels / ThermalKilnTileEntity.CAPACITY);
    }
