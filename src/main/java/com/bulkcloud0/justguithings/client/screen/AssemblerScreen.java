...
public class AssemblerScreen extends ContainerScreen<AssemblerContainer> {
    ...
    private static final int PROGRESS_COLOR = 0xFF8E79C6;
    private static final int TEXT_COLOR = 0xFFE5E9ED;

    public AssemblerScreen(AssemblerContainer menu, PlayerInventory inventory, ITextComponent title) {
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        drawSlot(matrixStack, left + 25, top + 27);
        drawSlot(matrixStack, left + 43, top + 27);
        drawSlot(matrixStack, left + 25, top + 45);
        drawSlot(matrixStack, left + 43, top + 45);
        drawSlot(matrixStack, left + 115, top + 36);
        ...
        AbstractGui.fill(matrixStack, left + 77, top + 38, left + 111, top + 50, PROGRESS_BG_COLOR);
        int progressWidth = this.menu.getProgressScaled(32);
        if (progressWidth > 0) {
            AbstractGui.fill(matrixStack, left + 78, top + 39, left + 78 + progressWidth, top + 49, PROGRESS_COLOR);
        }
    ...
    protected void renderLabels(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        this.font.draw(matrixStack,
                "FE: " + this.menu.getEnergyStored() + " / " + AssemblerTileEntity.CAPACITY,
