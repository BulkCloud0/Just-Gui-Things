...
public class IndustrialAssemblerScreen extends ContainerScreen<IndustrialAssemblerContainer> {
    ...
    public IndustrialAssemblerScreen(IndustrialAssemblerContainer menu,
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        AbstractGui.fill(matrixStack, left + 91, top + 38, left + 110, top + 50, PROGRESS_BG_COLOR);
        int progressWidth = menu.getProgressScaled(17);
        if (progressWidth > 0) {
            AbstractGui.fill(matrixStack, left + 92, top + 39, left + 92 + progressWidth, top + 49, PROGRESS_COLOR);
        }
    ...
    protected void renderLabels(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        font.draw(matrixStack,
                "FE: " + menu.getEnergyStored() + " / " + IndustrialAssemblerTileEntity.CAPACITY,
