...
public class WireMillScreen extends ContainerScreen<WireMillContainer> {
    ...
    private static final int PROGRESS = 0xFFB8B1E3;
    private static final int TEXT = 0xFFE5E9ED;

    public WireMillScreen(WireMillContainer menu, PlayerInventory inventory, ITextComponent title) {
    ...
    protected void renderLabels(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        font.draw(matrixStack,
                "FE: " + menu.getEnergyStored() + " / " + WireMillTileEntity.CAPACITY,
                82.0F, 6.0F, TEXT);
        font.draw(matrixStack,
