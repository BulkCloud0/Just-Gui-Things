...
public class FluidContainerStationScreen extends ContainerScreen<FluidContainerStationContainer> {
    ...
    public FluidContainerStationScreen(FluidContainerStationContainer menu,
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        drawSlot(matrixStack, left + 25, top + 33);
        drawSlot(matrixStack, left + 25, top + 54);
        drawSlot(matrixStack, left + 93, top + 33);
        drawSlot(matrixStack, left + 93, top + 54);
        ...
        AbstractGui.fill(matrixStack, left + 130, top + 24, left + 141, top + 74, BAR_BG);
        if (fluidHeight > 0) {
            AbstractGui.fill(matrixStack, left + 132, top + 72 - fluidHeight, left + 139, top + 72, FLUID);
        }
    ...
    protected void renderLabels(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        font.draw(matrixStack, I18n.get("screen.justguithings.fluid_container_station.drain"),
                48.0F, 38.0F, TEXT);
        font.draw(matrixStack, I18n.get("screen.justguithings.fluid_container_station.fill"),
                48.0F, 59.0F, TEXT);
