...
public class IndustrialSawmillScreen extends ContainerScreen<IndustrialSawmillContainer> {
    ...
    private static final int PROGRESS_COLOR = 0xFFB88D4A;
    private static final int TEXT_COLOR = 0xFFE5E9ED;

    public IndustrialSawmillScreen(IndustrialSawmillContainer menu, PlayerInventory inventory, ITextComponent title) {
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        if (energyHeight > 0) {
            AbstractGui.fill(matrixStack, left + 163, top + 72 - energyHeight,
                    left + 170, top + 72, ENERGY_COLOR);
        }
    }
    ...
    protected void renderLabels(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        font.draw(matrixStack,
                "FE: " + menu.getEnergyStored() + " / " + IndustrialSawmillTileEntity.CAPACITY,
