...
public class StampingPressScreen extends ContainerScreen<StampingPressContainer> {
    ...
    public StampingPressScreen(StampingPressContainer menu, PlayerInventory inventory, ITextComponent title) {
    ...
    protected void renderLabels(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        this.font.draw(matrixStack,
                "FE: " + this.menu.getEnergyStored() + " / " + StampingPressTileEntity.CAPACITY,
