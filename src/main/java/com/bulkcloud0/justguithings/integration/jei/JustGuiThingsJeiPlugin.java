...
public final class JustGuiThingsJeiPlugin implements IModPlugin {
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        registration.addRecipeCategories(
                ...
                new QuenchingRecipeCategory(registration.getJeiHelpers().getGuiHelper()),
                new ThermalRecipeCategory(registration.getJeiHelpers().getGuiHelper()));
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        if (world != null) {
            ...
            registration.addRecipes(world.getRecipeManager().getAllRecipesFor(ModRecipes.QUENCHING_TYPE), QuenchingRecipeCategory.UID);
            registration.addRecipes(world.getRecipeManager().getAllRecipesFor(ModRecipes.THERMAL_TYPE), ThermalRecipeCategory.UID);
        }
    }
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(new ItemStack(ModItems.QUENCH_CHAMBER.get()), QuenchingRecipeCategory.UID);
        registration.addRecipeCatalyst(new ItemStack(ModItems.THERMAL_KILN.get()), ThermalRecipeCategory.UID);
    }
    ...
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        ...
        registration.addRecipeClickArea(QuenchChamberScreen.class, 69, 38, 36, 12, QuenchingRecipeCategory.UID);
        registration.addRecipeClickArea(ThermalKilnScreen.class, 69, 38, 36, 12, ThermalRecipeCategory.UID);
    }
}
