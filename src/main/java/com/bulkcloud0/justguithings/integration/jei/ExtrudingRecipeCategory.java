...
public final class ExtrudingRecipeCategory implements IRecipeCategory<ExtrudingRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(JustGuiThings.MOD_ID, "extruding");

    private final IDrawable background;
    private final IDrawable icon;

    public ExtrudingRecipeCategory(IGuiHelper guiHelper) {
        background = guiHelper.createBlankDrawable(120, 52);
        icon = guiHelper.createDrawableIngredient(new ItemStack(ModItems.PRECISION_EXTRUDER.get()));
    }
    ...
    @Override
    public Class<? extends ExtrudingRecipe> getRecipeClass() {
        return ExtrudingRecipe.class;
    }
    ...
    public ITextComponent getTitleAsTextComponent() {
        return new TranslationTextComponent("jei.justguithings.extruding");
    }
    ...
    @Override
    public void draw(ExtrudingRecipe recipe, MatrixStack matrixStack, double mouseX, double mouseY) {
